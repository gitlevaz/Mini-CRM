                ...
                <div class="col-md-12">
                    ...
                    <div class="">
                        <div class="box-header with-border"><br>
                            <h5 class="box-title"> Category Form</h5>
                        </div><br>
                        <!-- /.box-header -->
                        <!-- form start -->
                                ...
                                <input type="hidden" class="form-control" id="id"  name="id"  >
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group images">
                                                ...
                                                <div class="col-sm-8">     
                                                    <input type="text"  class="form-control" id="discription"  required  name="discription" value="">
                                                  </div><br>
                                            </div>
...
<script>
    ...
    $('#btn-submit').on('click', function(){
        ...
        let formData = new FormData(myForm);
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('add_catresearch')); ?>",
                    data: formData,
                    dataType: "JSON",
                    async:false,
                    contentType: false,
 ...
 function getAll() {
            $.ajax({
               type: "POST",
               url: "<?php echo e(route('catresearch.all')); ?>",
                ...
                //    console.log(response);
                    ...
                    $.each(response , function (q) { 
                       ...
                       var td7 = document.createElement('td');
                        ...
                        $(td1).html(q);
                        $(td2).html(response[q].name);

                        
                        $(td5).attr({class: 'text-center'});
                        $(td6).attr({class: 'text-center'});
                        $(td7).attr({class: 'text-center'});
        ...
        function selectdelete(id){
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('catresearch.delete')); ?>",
                data: {
                    id: id
                },
                dataType: "JSON",
...
<?php echo $__env->make('sb-layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.4\htdocs\blog_project\resources\views/research/company.blade.php ENDPATH**/ ?>